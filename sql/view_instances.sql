...
FROM SM_INSTANCES WHERE RUNNUMBER>100000  and (HOSTNAME like 'srv-C2C%' or HOSTNAME like 'mrg-c2f12%') )
...
FROM SM_INSTANCES  WHERE   (HOSTNAME like 'srv-C2C%' or HOSTNAME like 'mrg-c2f12%') )
WHERE run <= 25 
ORDER BY 1 DESC, 2 ASC); 
